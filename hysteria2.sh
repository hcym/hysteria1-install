...
insthysteria(){
    ...
    wget -N https://raw.githubusercontent.com/Ptechgithub/hysteria-install/main/hy2/install_server.sh
...
menu() {
    clear
    echo "###########################################################"
    echo -e "#        ${RED}Hysteria2 一one-click installation script${PLAIN}        #"
    ...
    echo -e " ${GREEN}5.${PLAIN} Show Hysteria 2 configuration file"
    echo " -------------"
